...
class ProductDetailsModel {
  ...
  factory ProductDetailsModel.fromMap(Map<String, dynamic> map) {
    return ProductDetailsModel(
      ...
      activeMenu: map['activeMenu'] != null ? map['activeMenu'] as String : null,
      activeShopMenuID: map['activeShopMenuID'] != null ? map['activeShopMenuID'] as int : null,
    );
  }
  ...
  @override
  int get hashCode => items.hashCode ^ note.hashCode ^ activeMenu.hashCode ^ activeShopMenuID.hashCode;
}
...
class ProductDataModel {
  ...
  factory ProductDataModel.fromMap(Map<String, dynamic> map) {
    return ProductDataModel(
      ...
      variations: List<ProductVariationDataModel>.from(
        (map['variations'] as List<dynamic>).map<ProductVariationDataModel?>(
          (x) => ProductVariationDataModel.fromMap(x as Map<String, dynamic>),
        ),
      ),
      hasMultipleVariation: map['hasMultipleVariation'] as bool,
      addons: List<ProductsAddonDataModel>.from(
        (map['addons'] as List<dynamic>).map<ProductsAddonDataModel?>(
          (x) => ProductsAddonDataModel.fromMap(x as Map<String, dynamic>),
        ),
      ),
      hasAddons: map['hasAddons'] as bool,
      hasMasterAddons: map['hasMasterAddons'] as bool,
      masterAddons: List<ProductMasterAddonDataModel>.from(
        (map['masterAddons'] as List<dynamic>).map<ProductMasterAddonDataModel?>(
          (x) => ProductMasterAddonDataModel.fromMap(x as Map<String, dynamic>),
        ),
      ),
    );
  }
...
class ProductVariationDataModel {
  ...
  ProductVariationDataModel copyWith({
    ...
    return ProductVariationDataModel(
      ...
      variationmasteraddons: variationmasteraddons ?? this.variationmasteraddons,
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'variationmasteraddons': variationmasteraddons?.map((x) => x.toMap()).toList(),
    };
  }
  ...
  factory ProductVariationDataModel.fromMap(Map<String, dynamic> map) {
    return ProductVariationDataModel(
      ...
      name: map['name'] != null ? map['name'] as String : null,
      price: map['price'] != null ? map['price'] as String : null,
      displayPrice: map['displayPrice'] != null ? map['displayPrice'] as String : null,
      ingredients: map['ingredients'] != null ? map['ingredients'] as String : null,
      isUnlimitedStock: map['isUnlimitedStock'] != null ? map['isUnlimitedStock'] as String : null,
      ...
      //     : null,
      selectedallergens:
          map['selectedallergens'] != null ? List<dynamic>.from((map['selectedallergens'] as List<dynamic>)) : null,
      allergensMaster:
          map['allergensMaster'] != null ? List<dynamic>.from((map['allergensMaster'] as List<dynamic>)) : null,
      variationmasteraddons: map['variationmasteraddons'] != null
          ? List<ProductMasterAddonDataModel>.from(
              (map['variationmasteraddons'] as List<dynamic>).map<ProductMasterAddonDataModel?>(
                (x) => ProductMasterAddonDataModel.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
  ...
  factory ProductVariationDataModel.fromJson(String source) =>
      ProductVariationDataModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ProductVariationDataModel(pvID: $pvID, name: $name, price: $price, displayPrice: $displayPrice, ingredients: $ingredients, isUnlimitedStock: $isUnlimitedStock, stock: $stock, allergens: $allergens, selectedallergens: $selectedallergens, allergensMaster: $allergensMaster, variationmasteraddons: $variationmasteraddons)';
  }
...
class ProductsAllergenDataModel {
  ...
  factory ProductsAllergenDataModel.fromJson(String source) =>
      ProductsAllergenDataModel.fromMap(json.decode(source) as Map<String, dynamic>);
...
class ProductsAddonDataModel {
  ...
  factory ProductsAddonDataModel.fromJson(String source) =>
      ProductsAddonDataModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() => 'ProductsAddonDataModel(name: $name, id: $id, options: $options)';

  @override
  bool operator ==(covariant ProductsAddonDataModel other) {
    if (identical(this, other)) return true;

    return other.name == name && other.id == id && listEquals(other.options, options);
  }
...
class ProductsOptionDataModel {
  ...
  factory ProductsOptionDataModel.fromMap(Map<String, dynamic> map) {
    return ProductsOptionDataModel(
      ...
      price: map['price'] != null ? map['price'] as String : null,
      price_formatted: map['price_formatted'] != null ? map['price_formatted'] as String : null,
  ...
  factory ProductsOptionDataModel.fromJson(String source) =>
      ProductsOptionDataModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  int get hashCode {
    return text.hashCode ^ price.hashCode ^ price_formatted.hashCode ^ value.hashCode ^ checked.hashCode;
  }
}
...
class ProductMasterAddonDataModel {
  ...
  factory ProductMasterAddonDataModel.fromMap(Map<String, dynamic> map) {
    return ProductMasterAddonDataModel(
      id: map['id'] != null ? map['id'] as String : null,
      name: map['name'] != null ? map['name'] as String : null,
      minimumRequired: map['minimumRequired'] != null ? map['minimumRequired'] as String : null,
      maximumRequired: map['maximumRequired'] != null ? map['maximumRequired'] as String : null,
      options: List<ProductsMasterAddonsOptionDataModel>.from(
        (map['options'] as List<dynamic>).map<ProductsMasterAddonsOptionDataModel?>(
          (x) => ProductsMasterAddonsOptionDataModel.fromMap(x as Map<String, dynamic>),
        ),
      ),
    );
  }
  ...
  factory ProductMasterAddonDataModel.fromJson(String source) =>
      ProductMasterAddonDataModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  int get hashCode {
    return id.hashCode ^ name.hashCode ^ minimumRequired.hashCode ^ maximumRequired.hashCode ^ options.hashCode;
  }
}
...
class ProductsMasterAddonsOptionDataModel {
  ...
  factory ProductsMasterAddonsOptionDataModel.fromMap(Map<String, dynamic> map) {
    return ProductsMasterAddonsOptionDataModel(
      text: map['text'] != null ? map['text'] as String : null,
      price: map['price'] != null ? map['price'] as String : null,
      price_formatted: map['price_formatted'] != null ? map['price_formatted'] as String : null,
  ...
  factory ProductsMasterAddonsOptionDataModel.fromJson(String source) =>
      ProductsMasterAddonsOptionDataModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  int get hashCode {
    return text.hashCode ^ price.hashCode ^ price_formatted.hashCode ^ itemId.hashCode ^ checked.hashCode;
  }
}
