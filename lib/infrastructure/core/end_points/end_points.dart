...
class Endpoints {
  static const String kDebugBaseUrl = 'https://ordergro.com/v2/';
  static const String kBaseUrl = 'https://ordergro.com/v2/';
  static const String kTableReservationBaseUrl = 'https://dev.ferns-it.in/view-reservation';

  static const String kPromotionsBaseUrl = 'https://shopadmin.vgrex.com/';

  static String get baseUrl => kDebugMode ? kDebugBaseUrl : kBaseUrl;
  ...
  static const String kListGlobalCategories = 'shop/home/sellerglobalcategories';
  ...
  static const String kListProductsByCategoryName = 'shop/products_with_category_name';
  static const String kListProductsUpdatedMinData = 'shop/products_updated_min_data';
  static const String kProductsPagination = 'shop/products/pagination';
  static const String kProductsPaginationMinData = 'shop/products/pagination_min_data';
  ...
  static const String kShopDeliverySlots = 'https://ordergro.com/v2/shop/deliveryslots/';

  // Offer Endpoints
  static const String kListActiveOffers = 'shop/offer/list';
  static const String kValidateOneTimeVoucher = 'shop/offer/validateonetimevoucher/';
  static const String kValidateCouponCode = 'shop/user/offer/validatecoupencode';
  ...
  static const String kReservationHistory = 'shop/user/table/reservationhistory';

  // Dining table reservation endpoints
  static const String kDiningTableReservationNew = 'shop/user/diningtable/reservation/new';
  static const String kDiningTableReservationSendOtp = 'shop/user/diningtable/reservation/sendotp';
  static const String kDiningTableReservationView = 'shop/user/diningtable/reservation/view';
  static const String kDiningTableReservationCancel = 'shop/user/diningtable/reservation/cancel';
  static const String kDiningTableReservationUpdate = 'shop/user/diningtable/reservation/update';
  static const String kDiningTableReservationSendMailToShop = 'shop/user/diningtable/reservation/sendmailtoshop';
  static const String kDiningTableReservationCreatePaymentIntent =
      'shop/user/diningtable/reservation/createpaymentintent';
  static const String kDiningTableReservationHistory = 'shop/user/diningtable/reservation/history/';
  ...
  static const String kTakeawayCalculator = 'shop/user/checkout/takeawaycalculator';
  static const String kGuestTakeawayCalculator = 'shop/guest/checkout/takeawaycalculator';
  static const String kDeliveryCalculator = 'shop/user/checkout/deliverycalculator';
  static const String kGuestDeliveryCalculator = 'shop/guest/checkout/deliverycalculator';
  static const String kCreatePaymentIntent = 'shop/user/web/checkout/createpaymentintent';
  static const String kCancelPaymentIntent = 'shop/user/web/checkout/cancelpaymentintent';
  static const String kCaptureAmount = 'shop/user/web/checkout/captureamount';
  //Promotions
  static const String kPromotion = 'promotions/fetch-mobile-restaurent-promotions/';
