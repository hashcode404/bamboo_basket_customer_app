...
import 'package:aj_customer/domain/table/i_table_repo.dart';
...
class TableRepo implements ITableRepo {
  @override
  Future<Either<AppExceptions, List<TableReservationDetails>>> reservationHistory() async {
    try {
      ...
      return right(data.map((e) => TableReservationDetails.fromJson(e)).toList());
